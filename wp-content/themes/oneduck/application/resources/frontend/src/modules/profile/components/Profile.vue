            ...
            <div class="form__block form__block_password">
                ...
                <template v-if="form.changePassword">
                    ...
                    <div class="form__group form__group_inp">
                        ...
                        <div class="form__group__field js-form__group__field" :class="{'error': (errors.repeatPassword)}">
...
<script>
import ErrorResponse from "@/modules/profile/components/ErrorResponse"
