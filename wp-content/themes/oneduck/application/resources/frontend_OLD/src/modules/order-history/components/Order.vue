            ...
            <div class="card-body card__body">
                ...
                <div class="table__wrap">
                    <table class="table">
                        ...
                        >
                            <OrderItem v-for="item in category.children" :key="item.product_id" :item="item" :copy-state="copyStatuses[item.product_id]"/>
                        </CartListCategory>
                    </table>
                </div>
...
import OrderItem from "@modules/order-history/components/OrderItem";
