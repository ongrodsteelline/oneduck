<div class="modal fade" id="Modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog modal__dialog js-modal__dialog" role="document">
        ...
        <div class="modal-content modal__content modal__content_finish">
            ...
            <div class="modal-body modal__content__body">
                <form action="" class="form form_al">
                    <img src="<?php echo e(bloginfo('template_url')); ?>/app/assets/img/modal/finish.png" alt="">
        ...
        <div class="modal-content modal__content modal__content_step">
            ...
            <div class="modal-body modal__content__body">
                <form action="" class="form form_al">
                    <img src="<?php echo e(bloginfo('template_url')); ?>/app/assets/img/modal/process.png" alt="">
...
</div><?php /**PATH /var/www/wp-content/themes/oneduck/application/resources/views/popup/default.blade.php ENDPATH**/ ?>