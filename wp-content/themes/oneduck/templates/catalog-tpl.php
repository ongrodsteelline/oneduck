...
<main style="opacity: 0.2;" class="main main__pd main_table">
                        ...
                        <table class="table">
                            <thead>
                                <tr>
                                    ...
                                    <th class="table__brend">Бренд <span><i class="ic-filter_up"></i><i class="ic-filter_down"></i></span></th>
                                    <th class="table__multiplicity">Кратность 
                                        <i class="ic-info js-info" data-toggle="tooltip" data-placement="left" title="Вы можете заказать товар только в количестве, кратном указанном"></i>
                                    </th>
                                    <th class="table__izmer">Ед. изм.</th>
                                    <th class="table__scale">Наличие <span><i class="ic-filter_up"></i><i class="ic-filter_down"></i></span></th>
                                    <th class="table__PPC">РРЦ, <span>руб</span></th>
                                    <th class="table__cena">Цена, <span>руб</span> <span><i class="ic-filter_up"></i><i class="ic-filter_down"></i></span></th>
                    ...
                    <nav aria-label="Page navigation example" class="pagination__wrap">
                        <ul class="pagination"><span>Страница:</span>
                            ...
                            <li class="page-item pagination__item active"><a class="page-link pagination__link"
                                    href="#">3</a></li>
                            <li class="page-item pagination__item pagination__item_dis"><a class="page-link pagination__link" href="#">4</a>
                            </li>
                            <li class="page-item pagination__item pagination__item_dis"><a class="page-link pagination__link" href="#">5</a>
                            </li>
                            <li class="page-item pagination__item pagination__item_dis"><a class="page-link pagination__link" href="#">6</a>
                            </li>
